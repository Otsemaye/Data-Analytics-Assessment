...
-- Lets count qualifying inflow transactions per user per month
...
-- Lets calculate average transactions per user across all months
avg_tx_per_user AS (
  SELECT 
    user_id,
...
-- We'll assign frequency categories based on average monthly transactions
...
-- The final aggregation by frequency category
SELECT 
  frequency_category,
